...
CODEGEN_OUTPUT_PACKAGE :=github.com/bertinatto/aws-efs-csi-driver-operator/pkg/generated
CODEGEN_API_PACKAGE :=github.com/bertinatto/aws-efs-csi-driver-operator/pkg/apis
...
$(call build-image,aws-efs-csi-driver-operator,$(IMAGE_REGISTRY)/ocp/4.4:aws-efs-csi-driver-operator,./Dockerfile.rhel7,.)

...
import (
	...
	"github.com/bertinatto/aws-efs-csi-driver-operator/pkg/generated/clientset/versioned/scheme"
...
// CsiV1alpha1Client is used to interact with features provided by the csi.efs.aws.com group.
type CsiV1alpha1Client struct {
	restClient rest.Interface
}

func (c *CsiV1alpha1Client) EFSCSIDrivers(namespace string) EFSCSIDriverInterface {
	return newEFSCSIDrivers(c, namespace)
}
